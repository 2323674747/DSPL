...
IMAGE_PATH = osp.join(ROOT_PATH2, '/home/aaa/zll/DFRFS-main-yuanma/DFRFS-main/data/domainnet/images')
#SPLIT_PATH = osp.join(ROOT_PATH2, 'data/domainnet/split')
SPLIT_PATH = osp.join(ROOT_PATH2, '/home/aaa/zll/DFRFS-main-yuanma/DFRFS-main/data/domainnet/split')
## 【修改点 1】动态修复路径前缀
def fix_path(name):
    # 将错误路径前缀替换为正确的 images 文件夹路径
    name = name.replace('/DFR_TNNLS_CODE/data/domainnet/', '')
    return osp.join(IMAGE_PATH, name)
