...
IMAGE_PATH1 = osp.join(ROOT_PATH2, '/home/aaa/zll/DFRFS-main/data/mini-imagenet/images')
#SPLIT_PATH = osp.join(ROOT_PATH2, 'data/miniimagenet/split')
SPLIT_PATH = osp.join(ROOT_PATH2, '/home/aaa/zll/DFRFS-main/data/mini-imagenet/split')
