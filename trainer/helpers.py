...
from model.models.protonet2 import ProtoNet2
from model.models.matchnet import MatchNet
from model.models.feat import FEAT
from model.models.feat2 import FEAT2
...
def get_dataloader(args):
    ...
    if args.dataset == 'Domain_FS':
        ...
        val_loader = DataLoader(dataset=valset,
                                ...
                                pin_memory=True)
        '''
        ### Evaluation Setting B: Support set from five source domains during testing phase
        ...
        ### Evaluation Setting A: Support set and query set only from one target domain during testing phase
